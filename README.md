...
## 참고사항
 ...
 - /content/projects (프로젝트) 아래에 글을 올리면 Project 페이지의 글 목록에 글이 보이고 content/blog (블로그) 아래에 글을 올리면 Article 페이지의 글 목록에 글이 보입니다. 

## 업데이트 목록

### 2025.11.30
 - 마크다운 문서의 링크를 사이트의 라우팅 설정대로 리다이렉트 되도록 하는 유틸리티 파일 추가
 - 디자인 개선
